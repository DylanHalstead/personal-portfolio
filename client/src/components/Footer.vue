<template>
  ...
  >
    ...
    <ul class="flex md:mb-0 mb-2">
      <li class="ml-4">
        <a href="mailto:dylanhalstead11@gmail.com">
          <svg
            ...
            fill="currentColor"
            class="h-6 opacity-60 hover:opacity-100 transition-opacity duration-200 ease-in-out"
            viewBox="0 0 16 16"
          >
            <path
      ...
      <li class="ml-4">
        <a href="https://www.linkedin.com/in/dylanhalstead/">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            class="h-6 opacity-60 hover:opacity-100 transition-opacity duration-200 ease-in-out"
      ...
      <li class="ml-4">
        <a href="https://github.com/DylanHalstead">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            class="h-6 opacity-60 hover:opacity-100 transition-opacity duration-200 ease-in-out"
