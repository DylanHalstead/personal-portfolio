<template>
  ...
  >
    ...
    <div class="flex md:mb-0 mb-2">
      <a href="mailto:dylanhalstead11@gmail.com" class="ml-4">
      ...
      <a href="https://www.linkedin.com/in/dylanhalstead/" class="ml-4">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-6" viewBox="0 0 16 16">
          <path
      ...
      <a href="https://github.com/DylanHalstead" class="ml-4">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-6" viewBox="0 0 16 16">
          <path
